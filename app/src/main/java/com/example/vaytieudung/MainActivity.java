            ...
            public void onClick(View view) {
                if(checkNulll(editTienVay,editChiPhi,editThuNhap)){
                    ...
                    if(tienVay >= 20000000 && tienVay <= ((tnThang - chiPhi)*10)){
                        ...
                        double dlaiSuat = Integer.parseInt(laiSuat);
                        double dTGVay = Integer.parseInt(tgVay);

                        double tiLeLaiSuatHangThang = dlaiSuat/dTGVay;

                        double LaiSuatHangHang = tienVay * tiLeLaiSuatHangThang/100;

                        DecimalFormat decimalFormat = new DecimalFormat("###,###.####");

                        String KQ = decimalFormat.format(LaiSuatHangHang);
